...
public class ReplaceMethod {
    public static void main(String[] args) {
      ...
      s =  s.replace('a' , 'e');
        ...
        String day = "Today is monday. we will see you on monday. its monday";
        day = day.replace("monday" , "tuesday");

        System.out.println(day);


        String str = "Today is monday. we will see you on monday. its monday";
        System.out.println(str.replaceFirst("monday", "tuesday"));

        String target= "Today is monday. we will see you on monday. its monday";
