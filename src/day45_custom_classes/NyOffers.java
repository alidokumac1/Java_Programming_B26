...
public class NyOffers {
    public static void main(String[] args) {
        ...
        ArrayList<Offer> allOffers = new ArrayList<>();// creating an ArrayList thay will hold Offer objects
       ...
       allOffers.add( new Offer("Amazon", "New York", 180_000, true, 15));// creating an Offer object and added to the ArrayList
        ...
        allOffers.addAll(Arrays.asList(
                new Offer("Discord", " Atlanta", 150_000, false, 13),
                new Offer("Netflix", "Canada", 170_000, true, 12)
        )); // added Offer objects using the var args of the asList method to add multiple Offer objects at the sam time
        System.out.println();
        System.out.println(allOffers);
