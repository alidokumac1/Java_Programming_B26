    ...
    public static void main(String[] args) {
        ...
        if (budget > 0 && budget < 300_000) {
            ...
            if (isAvailable) {
                ...
                ad += "\nGated : " + (gated ? "Yes" : "No"); // this means if the gated boolean is true, it will concatenate yes into the ad,
                //  but if the gated boolean is false it will concatenate "no" into the ad
                ad += "\n" + "They allow pets: " + (allowPets ? "allow pets " : "They don't allow pets");
...
//            System.out.println("Here is the neighborhood fits your budget\n");
...
//                    "            gated - yes\n" +
//                    "            allow pets - no");
//        }else if (budget >= 160000 && budget <= 200000){
