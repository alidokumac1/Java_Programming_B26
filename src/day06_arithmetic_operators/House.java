...
public class House {
   ...
   */
        ...
        double costOfHouse = 1_000_000.99; // 4.5 | 100000.99
...
/*
       ...
       String houseType = "Penthouse" , address = "129481 Central Park";
        ...
        boolean hasBasement = false ,hasAttic = false , isOnSale = false ,hasPark = true ,hasPool = true;
